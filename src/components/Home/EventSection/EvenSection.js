...
export default function EvenSection() {
  return (
    <section className="container relative min-h-screen mx-auto">
      <div className="absolute mt-1 bg-white rounded-2xl -top-36">
        {/* for experience section */}
        <div className="flex flex-row items-center justify-center rounded-t-2xl  divide-x divide-[#ed99aa]  bg-[#da1e39] px-4  py-10 ">
